...
export default function EditReservation() {
    ...
    return (
        <div className="container pt-5">
            <div className="card container bg-secondary p-0 pb-2" 
                style={{ maxWidth: "600px", height: "100%", borderRadius: "10px" }}
            >
                <h2 className="card-header text-center text-light border-info">
                    Edit Reservation
                </h2>
                {reservation.data && (
                    <form onSubmit={submitHandler} className="mt-2">
                        ...
                        <div className="text-center">
                            ...
                            <button className="btn btn-dark text-light ml-1" onClick={cancelHandler}>
                                Cancel
                            </button>
                        </div>
                    </form>
